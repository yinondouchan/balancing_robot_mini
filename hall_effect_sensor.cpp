...
ISR (PCINT1_vect) // handle pin change interrupt for pins A0 to A5
{    
...
void init_hall_effect_sensors()
{
	...
	pinMode(LEFT_MOTOR_HALL_EFFECT_OUT1_PIN, INPUT_PULLUP); 
	pinMode(LEFT_MOTOR_HALL_EFFECT_OUT2_PIN, INPUT_PULLUP); 
	pinMode(RIGHT_MOTOR_HALL_EFFECT_OUT1_PIN, INPUT_PULLUP); 
	pinMode(RIGHT_MOTOR_HALL_EFFECT_OUT2_PIN, INPUT_PULLUP); 
